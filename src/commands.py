...
def iso_work(iso):
    try:
        ...
        print_red(f"An error occurred while processing the ISO: {e}")
...
def ending_chroot_and_cleaning_up():
    try:
        ...
        print_red(f"An error occurred while cleaning up: {e}")
    except Exception as e:
        print_red(f"An unexpected error occurred: {e}")
...
def build_iso(img):
    try:
        ...
        print_red(f"An error occurred while building the ISO: {e}")
    except Exception as e:
        print_red(f"An unexpected error occurred: {e}")
...
def remove_directories():
    try:
        ...
        print_red(f"An error occurred while removing directories: {e}")
    except Exception as e:
        print_red(f"An unexpected error occurred: {e}")
...
def install_image_to_device(device):
    try:
        ...
        print_red(f"An error occurred while installing the image to the device: {e}")
    except Exception as e:
        print_red(f"An unexpected error occurred: {e}")
